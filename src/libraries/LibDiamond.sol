...
library LibDiamond {
    ...
    bytes32 constant LOAN_STORAGE_POSITION = keccak256("diamond.standard.loan.storage");
    ...
    struct LoanStorage {
        ...
        uint256 interestRate; // Standard interest rate for all loans, in basis points (e.g., 500 = 5%)
    ...
    function setLendingDetails(uint256 _ltvRatio, uint256 _interestRate) internal {
